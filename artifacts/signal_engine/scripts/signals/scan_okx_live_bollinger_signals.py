...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scan OKX live candles for neutral Bollinger signals.")
    ...
    parser.add_argument("--signals-root", default=str(live_signals_root(WORKSPACE_ROOT) / "bollinger"))
