...
def _stage3_grid_state(artifact_root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "stage3c_atr_combinations_tested": grid.get("stage3c_atr_combinations_tested", 0) if grid else 0,
        "stage3c_value_ranges": grid.get("stage3c_value_ranges", {}) if grid else {},
        "atr_variant_results": [_compact_stage3_result(item) for item in grid.get("atr_variant_results", [])] if grid else [],
