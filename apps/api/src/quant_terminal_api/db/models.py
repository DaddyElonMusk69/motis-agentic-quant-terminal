...
stage0_universe_runs = Table(
    ...
    Column("validation_start", Date, nullable=True),
    Column("validation_end", Date, nullable=True),
    Column("locked_oos_start", Date, nullable=True),
    Column("locked_oos_end", Date, nullable=True),
...
stage1_research_sessions = Table(
    ...
    Column("validation_start", Date, nullable=False),
    Column("validation_end", Date, nullable=False),
    Column("locked_oos_start", Date, nullable=False),
    Column("locked_oos_end", Date, nullable=False),
